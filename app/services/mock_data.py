...
_TOP_PRODUCTS_ALL: list[TopProduct] = [
    ...
    TopProduct(productId="P-207", name="Audífonos Sony WH-1000XM5",      unitsSold=61, revenue=3_050_000),
    TopProduct(productId="P-318", name="Teclado Mecánico Redragon",      unitsSold=58, revenue=1_160_000),
    TopProduct(productId="P-055", name="Monitor Samsung 27 pulgadas",    unitsSold=52, revenue=5_200_000),
    ...
    TopProduct(productId="P-077", name="Parlante Bluetooth JBL Flip 6",  unitsSold=35, revenue=700_000),
    TopProduct(productId="P-501", name="Hub USB-C 7 en 1 Anker",        unitsSold=29, revenue=580_000),
    TopProduct(productId="P-088", name="Impresora HP LaserJet Pro",      unitsSold=24, revenue=2_400_000),
    ...
    TopProduct(productId="P-145", name="Tablet Samsung Galaxy Tab S9",   unitsSold=16, revenue=3_200_000),
    ...
    TopProduct(productId="P-774", name="Adaptador USB-C a DisplayPort",  unitsSold=3,  revenue=45_000),
    TopProduct(productId="P-882", name="Funda Laptop 15 pulgadas",       unitsSold=2,  revenue=30_000),
    TopProduct(productId="P-991", name="Limpiador Pantallas Kensington",  unitsSold=2, revenue=20_000),
...
def peak_hours() -> list[PeakHourItem]:
    counts = [4, 2, 1, 0, 0, 1, 3, 8, 14, 21, 27, 35, 48, 52, 44, 38, 31, 29, 63, 71, 58, 41, 22, 11]
